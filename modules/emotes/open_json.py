...
class Abrir_Arquivos_Emotes:
  def Case_Open_Labels(self):
    caminho_labels = "./data/arquivos_json/text_files/labels.json"
    with open(caminho_labels) as arquivo_labels:
      dados_labels = json.load(arquivo_labels)
    return dados_labels

  def Case_Open_Punch(self):
    caminho_gif_punch = "./data/arquivos_json/action_files/punch.json"
  ...
  def Case_Open_Slap(self):
    caminho_gif_slap = "./data/arquivos_json/action_files/slap.json"
  ...
  def Case_Open_Kiss(self):
    caminho_gif_kiss = "./data/arquivos_json/action_files/kiss.json"
  ...
  def Case_Open_Shy(self):
    caminho_gif_shy = "./data/arquivos_json/action_files/shy.json"
  ...
  def Case_Open_Hug(self):
    caminho_gif_hug = "./data/arquivos_json/action_files/hug.json"
  ...
  def Case_Open_Cuddle(self):
    caminho_gif_cuddle = "./data/arquivos_json/action_files/cuddle.json"
  ...
  def Case_Open_Pat(self):
    caminho_gif_pat = "./data/arquivos_json/action_files/pat.json"
  ...
  def Case_Open_Push(self):
    caminho_gif_push = "./data/arquivos_json/action_files/push.json"
  ...
  def Case_Open_Stare(self):
    caminho_gif_stare = "./data/arquivos_json/action_files/stare.json"
  ...
  def Case_Open_Highfive(self):
    caminho_gif_highfive = "./data/arquivos_json/action_files/highfive.json"
  ...
  def Case_Open_Poke(self):
    caminho_gif_poke = "./data/arquivos_json/action_files/poke.json"
  ...
  def Case_Open_Bite(self):
    caminho_gif_bite = "./data/arquivos_json/action_files/bite.json"
  ...
  def Case_Open_Lick(self):
    caminho_gif_lick = "./data/arquivos_json/action_files/lick.json"
  ...
  def Case_Open_Bonk(self):
    caminho_gif_bonk = "./data/arquivos_json/action_files/bonk.json"
  ...
  def Case_Open_Tickle(self):
    caminho_gif_tickle = "./data/arquivos_json/action_files/tickle.json"
  ...
  def Case_Open_Wave(self):
    caminho_gif_wave = "./data/arquivos_json/action_files/wave.json"
